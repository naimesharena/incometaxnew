...
FORM_SPECS = {
    "ITR-1": {
        ...
        "fields": COMMON_PERSONAL + [
            ...
            {"key": "donations_80g", "label": "80G Donations", "type": "grid",
             "section": "Deductions (VI-A)", "columns": [
                 {"key": "amount", "label": "Donation Amount", "type": "number"},
                 {"key": "percent", "label": "Deduction %", "type": "select",
                  "options": [{"value": "100", "label": "100%"},
                              {"value": "50", "label": "50%"}]},
                 {"key": "qualifying", "label": "Qualifying Limit?", "type": "select",
                  "options": [{"value": "no", "label": "Without limit"},
                              {"value": "yes", "label": "Subject to 10% limit"}]},
                 {"key": "mode", "label": "Mode", "type": "select",
                  "options": [{"value": "noncash", "label": "Non-cash / <= 2000"},
                              {"value": "cash", "label": "Cash > 2000 (ineligible)"}]}]},
    ...
    "ITR-2": {
        ...
        "fields": COMMON_PERSONAL + [
            ...
            _num("stcg_amount", "Quick entry: STT-paid equity STCG amount", "Capital Gains"),
            _num("stcg_cost", "Quick entry: STCG Cost", "Capital Gains"),
            {"key": "stcg_acq_date", "label": "Quick entry: Acquisition Date",
             "type": "date", "section": "Capital Gains"},
            {"key": "cg_assets", "label": "Capital Gain Assets (detailed grid)",
             "type": "grid", "section": "Capital Gains", "columns": [
                 {"key": "asset_class", "label": "Asset Class", "type": "select",
                  "options": [{"value": "securities", "label": "Securities (equity/MF)"},
                              {"value": "immovable", "label": "Immovable property"},
                              {"value": "other", "label": "Other"}]},
                 {"key": "listed_stt", "label": "Listed & STT-paid (112A/111A)?", "type": "select",
                  "options": [{"value": "yes", "label": "Yes"}, {"value": "no", "label": "No"}]},
                 {"key": "acq_date", "label": "Acquisition Date", "type": "date"},
                 {"key": "transfer_date", "label": "Transfer Date", "type": "date"},
                 {"key": "sale", "label": "Sale Consideration", "type": "number"},
                 {"key": "cost", "label": "Cost of Acquisition", "type": "number"},
                 {"key": "fmv", "label": "FMV 31/01/2018 (if pre-2018 listed)", "type": "number"}]},
        ] + TAXES_PAID + BANK_FIELDS,
    },
    "ITR-3": {
